...
Con esto finalizamos la sección, las ideas de la convolución y muchas propiedades que hemos obtenido aquí también se pueden conseguir al estudiar las series de Dirichlet que estudiaremos más adelante, no es difícil ver que la convolución controla los términos que aparecen al realizar un producto de dos de estas series. Abordaremos esto más adelante, veremos en particular que la función de Von Mangolth y la función de Möbius aparecen de manera natural también al estudiar las funciones $\dfrac{\zeta^{'}(s)}{\zeta(s)}$ y $\dfrac{1}{\zeta(s)}$.
\end{note}
