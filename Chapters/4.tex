...
\[
\left|e^{s T} \frac{1}{s}\left(1+\frac{s^2}{R^2}\right)\right| = e^{\sigma T}\left|\frac{1}{R e^{i \theta}}+\frac{e^{i \theta}}{R}\right| =e^{\sigma T}\left|\frac{e^{-i\theta}+e^{i\theta}}{R}\right|=e^{\sigma T}\left|\frac{2 \cos \theta}{R}\right| \ll e^{\sigma T} \frac{|\sigma|}{R^2},
\]
...
Como $g_T(s)$ es entera y el resto del integrando es analítico a la izquierda de $\sigma = 0$, tenemos, por el teorema de Cauchy,
