...
En variable compleja, un teorema muy importante es el llamado ``principio del argumento'', este nos dice que la derivada logarítmica de una función $f(z)$, manda polos y ceros de $f(z)$ en polos simples de $\dfrac{f^{\prime}(z)}{f(z)}$, con residuo la multiplicidad del polo y del cero respectivamente.
