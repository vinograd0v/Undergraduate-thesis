...
Para probar el TNP queremos ver que $\psi(x)\thicksim x$, en este punto, el camino a seguir es claro, necesitamos probar que la serie de Dirichlet de la función de Von Mangolth cumple las condiciones del teorema de Wiener-Ikehara y que además tiene un único polo simple en $s=1$ con residuo $1$.\\
...
donde $r$ es el mayor entero tal que $x>2^r$, sumando estas desigualdades obtenemos que
