...
$$
\sum_{g \in G} \chi(g)= \begin{cases}n, & \text { if } \chi=\chi_0 \\ 0, & \text { e.o.c }\end{cases}
$$

\item[(ii)] Dado $a \in G$:

$$
\sum_{\chi \in \widehat{G}} \chi(a)= \begin{cases}n, & \text { if } a=1 \\ 0, & \text { e.o.c }\end{cases}
$$
