...
\begin{itemize}
\item[1)] La función $\chi$ no siempre resulta completamente multiplicativa módulo $n$
\item[2)] Nuestro argumento depende de  probar que $L(1,\chi)\neq 0$.
\end{itemize}

Entonces para dar una prueba del teorema en un panorama general debemos  solucionar estos inconvenientes, para el primero de estos probaremos que las funciones $\chi$ llamadas carácteres de Dirichlet satisfacen condiciones de ortogonalidad y dualidad, lo que nos permitirá hacer ¡Análisis de Fourier!.