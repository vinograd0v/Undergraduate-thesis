...
% Text Node
\draw (125.36,236.93) node [anchor=north west][inner sep=0.75pt]  [font=\tiny,xscale=2,yscale=2]  {$( -R,0)$};
% Text Node
\draw (282.08,236.93) node [anchor=north west][inner sep=0.75pt]  [font=\tiny,xscale=2,yscale=2] [align=left] {$\displaystyle ( 0,0)$};
% Text Node
\draw (195.08,236.93) node [anchor=north west][inner sep=0.75pt]  [font=\tiny,xscale=2,yscale=2] [align=left] {$( -\delta ,0)$};
% Text Node
\draw (369,236.93) node [anchor=north west][inner sep=0.75pt]  [font=\tiny,xscale=2,yscale=2]  {$( R,0)$};
% Text Node
